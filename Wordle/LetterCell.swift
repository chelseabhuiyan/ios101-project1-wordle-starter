...
//This code uses a switch-case statement to set the appropriate background color and border color based on the specified LetterCellStyle. The RGBA values are provided in the comments.
